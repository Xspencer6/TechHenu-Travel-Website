        ...
        >
          <div className="container mx-auto px-4">
            ...
            <div className="flex w-full transition-all duration-300">
              ...
              <div
                className={`transition-all duration-300 ${isAvail ? "w-[calc(100% - 540px)] lg:w-[calc(100% - 600px)]" : "w-full"}`}
              >
              ...
              {/* Sidebar package */}
              <div
                className={`fixed right-0 z-50 bg-slate-200 shadow-xl transition-transform duration-300 ease-in-out top-[71.6px]
